...
EntityFilter = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "google.cloud.datastore_admin_v1.proto.datastore_admin_pb2",
        "__doc__": """Identifies a subset of entities in a project. This is
  specified as combinations of kinds and namespaces (either or both of
  which may be all, as described in the following examples). Example
  usage:
  ...
  Kinds Foo and Bar only in the default namespace: kinds=[‘Foo’, ‘Bar’],
  namespace_ids=[’’]
  
  Kinds Foo and Bar in both the default and Baz namespaces: kinds=[‘Foo’,
  ‘Bar’], namespace_ids=[’‘, ’Baz’]
