...
def test_lookup_rest_unset_required_fields():
    transport = transports.DatastoreRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_run_query_rest_required_fields(request_type=datastore.RunQueryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).run_query._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_run_aggregation_query_rest_required_fields(request_type=datastore.RunAggregationQueryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).run_aggregation_query._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_begin_transaction_rest_required_fields(request_type=datastore.BeginTransactionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).begin_transaction._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_commit_rest_required_fields(request_type=datastore.CommitRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).commit._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_rollback_rest_required_fields(request_type=datastore.RollbackRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).rollback._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_allocate_ids_rest_required_fields(request_type=datastore.AllocateIdsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).allocate_ids._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reserve_ids_rest_required_fields(request_type=datastore.ReserveIdsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).reserve_ids._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
