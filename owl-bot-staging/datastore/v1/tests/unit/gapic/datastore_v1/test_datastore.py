...
async def test_run_query_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.run_query] = mock_rpc
...
async def test_run_aggregation_query_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.run_aggregation_query] = mock_rpc
...
async def test_allocate_ids_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.allocate_ids] = mock_rpc
...
async def test_reserve_ids_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.reserve_ids] = mock_rpc
...
def test_lookup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreRestInterceptor, "post_lookup_with_metadata") as post_with_metadata, \
...
def test_run_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreRestInterceptor, "post_run_query_with_metadata") as post_with_metadata, \
...
def test_run_aggregation_query_rest_bad_request(request_type=datastore.RunAggregationQueryRequest):
    client = DatastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_run_aggregation_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreRestInterceptor, "post_run_aggregation_query_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = datastore.RunAggregationQueryResponse.to_json(datastore.RunAggregationQueryResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = datastore.RunAggregationQueryResponse(), metadata
...
def test_begin_transaction_rest_bad_request(request_type=datastore.BeginTransactionRequest):
    client = DatastoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_begin_transaction_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreRestInterceptor, "post_begin_transaction_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = datastore.BeginTransactionResponse.to_json(datastore.BeginTransactionResponse())
        req.return_value.content = return_value
...
def test_commit_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreRestInterceptor, "post_commit_with_metadata") as post_with_metadata, \
...
def test_rollback_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreRestInterceptor, "post_rollback_with_metadata") as post_with_metadata, \
...
def test_allocate_ids_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreRestInterceptor, "post_allocate_ids_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = datastore.AllocateIdsResponse.to_json(datastore.AllocateIdsResponse())
        req.return_value.content = return_value
...
def test_reserve_ids_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreRestInterceptor, "post_reserve_ids_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = datastore.ReserveIdsResponse.to_json(datastore.ReserveIdsResponse())
        req.return_value.content = return_value
