...
class DatastoreAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DatastoreTransport, Callable[..., DatastoreTransport]]] = "grpc_asyncio",
    ...
    async def run_query(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.run_query]
    ...
    async def run_aggregation_query(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.run_aggregation_query]
    ...
    async def allocate_ids(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.allocate_ids]
    ...
    async def reserve_ids(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.reserve_ids]
