...
class DatastoreRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_allocate_ids(self, request: datastore.AllocateIdsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.AllocateIdsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_allocate_ids_with_metadata(self, response: datastore.AllocateIdsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.AllocateIdsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for allocate_ids
    ...
    def pre_begin_transaction(self, request: datastore.BeginTransactionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.BeginTransactionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_begin_transaction_with_metadata(self, response: datastore.BeginTransactionResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.BeginTransactionResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for begin_transaction
    ...
    def pre_commit(self, request: datastore.CommitRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.CommitRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_commit_with_metadata(self, response: datastore.CommitResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.CommitResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for commit
    ...
    def pre_lookup(self, request: datastore.LookupRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.LookupRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_lookup_with_metadata(self, response: datastore.LookupResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.LookupResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for lookup
    ...
    def pre_reserve_ids(self, request: datastore.ReserveIdsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.ReserveIdsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_reserve_ids_with_metadata(self, response: datastore.ReserveIdsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.ReserveIdsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for reserve_ids
    ...
    def pre_rollback(self, request: datastore.RollbackRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.RollbackRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_rollback_with_metadata(self, response: datastore.RollbackResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.RollbackResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for rollback
    ...
    def pre_run_aggregation_query(self, request: datastore.RunAggregationQueryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.RunAggregationQueryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_run_aggregation_query_with_metadata(self, response: datastore.RunAggregationQueryResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.RunAggregationQueryResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for run_aggregation_query
    ...
    def pre_run_query(self, request: datastore.RunQueryRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.RunQueryRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_run_query_with_metadata(self, response: datastore.RunQueryResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore.RunQueryResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for run_query
...
class DatastoreRestTransport(_BaseDatastoreRestTransport):
    ...
    class _AllocateIds(_BaseDatastoreRestTransport._BaseAllocateIds, DatastoreRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreRestTransport._BaseAllocateIds._get_http_options()

            request, metadata = self._interceptor.pre_allocate_ids(request, metadata)
            transcoded_request = _BaseDatastoreRestTransport._BaseAllocateIds._get_transcoded_request(http_options, request)

            body = _BaseDatastoreRestTransport._BaseAllocateIds._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseAllocateIds._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._AllocateIds._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = self._interceptor.post_allocate_ids_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _BeginTransaction(_BaseDatastoreRestTransport._BaseBeginTransaction, DatastoreRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreRestTransport._BaseBeginTransaction._get_http_options()

            request, metadata = self._interceptor.pre_begin_transaction(request, metadata)
            transcoded_request = _BaseDatastoreRestTransport._BaseBeginTransaction._get_transcoded_request(http_options, request)

            body = _BaseDatastoreRestTransport._BaseBeginTransaction._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseBeginTransaction._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._BeginTransaction._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = datastore.BeginTransactionResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _Commit(_BaseDatastoreRestTransport._BaseCommit, DatastoreRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseDatastoreRestTransport._BaseCommit._get_transcoded_request(http_options, request)

            body = _BaseDatastoreRestTransport._BaseCommit._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseCommit._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._Commit._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _Lookup(_BaseDatastoreRestTransport._BaseLookup, DatastoreRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseDatastoreRestTransport._BaseLookup._get_transcoded_request(http_options, request)

            body = _BaseDatastoreRestTransport._BaseLookup._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseLookup._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._Lookup._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ReserveIds(_BaseDatastoreRestTransport._BaseReserveIds, DatastoreRestStub):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreRestTransport._BaseReserveIds._get_http_options()

            request, metadata = self._interceptor.pre_reserve_ids(request, metadata)
            transcoded_request = _BaseDatastoreRestTransport._BaseReserveIds._get_transcoded_request(http_options, request)

            body = _BaseDatastoreRestTransport._BaseReserveIds._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseReserveIds._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._ReserveIds._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_reserve_ids_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _Rollback(_BaseDatastoreRestTransport._BaseRollback, DatastoreRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseDatastoreRestTransport._BaseRollback._get_transcoded_request(http_options, request)

            body = _BaseDatastoreRestTransport._BaseRollback._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseRollback._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._Rollback._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_rollback_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _RunAggregationQuery(_BaseDatastoreRestTransport._BaseRunAggregationQuery, DatastoreRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreRestTransport._BaseRunAggregationQuery._get_http_options()

            request, metadata = self._interceptor.pre_run_aggregation_query(request, metadata)
            transcoded_request = _BaseDatastoreRestTransport._BaseRunAggregationQuery._get_transcoded_request(http_options, request)

            body = _BaseDatastoreRestTransport._BaseRunAggregationQuery._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseRunAggregationQuery._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._RunAggregationQuery._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_run_aggregation_query_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = datastore.RunAggregationQueryResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _RunQuery(_BaseDatastoreRestTransport._BaseRunQuery, DatastoreRestStub):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseDatastoreRestTransport._BaseRunQuery._get_transcoded_request(http_options, request)

            body = _BaseDatastoreRestTransport._BaseRunQuery._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseRunQuery._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._RunQuery._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_run_query_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _CancelOperation(_BaseDatastoreRestTransport._BaseCancelOperation, DatastoreRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = self._interceptor.pre_cancel_operation(request, metadata)
            transcoded_request = _BaseDatastoreRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseDatastoreRestTransport._BaseDeleteOperation, DatastoreRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreRestTransport._BaseDeleteOperation._get_http_options()

            request, metadata = self._interceptor.pre_delete_operation(request, metadata)
            transcoded_request = _BaseDatastoreRestTransport._BaseDeleteOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseDeleteOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseDatastoreRestTransport._BaseGetOperation, DatastoreRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreRestTransport._BaseGetOperation._get_http_options()

            request, metadata = self._interceptor.pre_get_operation(request, metadata)
            transcoded_request = _BaseDatastoreRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseDatastoreRestTransport._BaseListOperations, DatastoreRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreRestTransport._BaseListOperations._get_http_options()

            request, metadata = self._interceptor.pre_list_operations(request, metadata)
            transcoded_request = _BaseDatastoreRestTransport._BaseListOperations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDatastoreRestTransport._BaseListOperations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
