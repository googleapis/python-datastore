...
from google.cloud.datastore_v1.types.query_profile import QueryPlan
from google.cloud.datastore_v1.types.query_profile import ResultSetStats
from google.cloud.datastore_v1.types.query_profile import QueryMode
