...
def test_export_entities_rest_required_fields(request_type=datastore_admin.ExportEntitiesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).export_entities._get_unset_required_fields(jsonified_request)
...
def test_export_entities_rest_unset_required_fields():
    transport = transports.DatastoreAdminRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_import_entities_rest_required_fields(request_type=datastore_admin.ImportEntitiesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).import_entities._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
