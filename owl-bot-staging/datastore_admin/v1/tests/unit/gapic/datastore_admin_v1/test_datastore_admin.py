...
async def test_export_entities_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.export_entities] = mock_rpc
...
async def test_import_entities_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_entities] = mock_rpc
...
def test_export_entities_rest_bad_request(request_type=datastore_admin.ExportEntitiesRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_export_entities_with_metadata") as post_with_metadata, \
...
def test_import_entities_rest_bad_request(request_type=datastore_admin.ImportEntitiesRequest):
    client = DatastoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_import_entities_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_import_entities_with_metadata") as post_with_metadata, \
...
def test_create_index_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_create_index_with_metadata") as post_with_metadata, \
...
def test_delete_index_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_delete_index_with_metadata") as post_with_metadata, \
...
def test_get_index_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_get_index_with_metadata") as post_with_metadata, \
...
def test_list_indexes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatastoreAdminRestInterceptor, "post_list_indexes_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = datastore_admin.ListIndexesResponse.to_json(datastore_admin.ListIndexesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = datastore_admin.ListIndexesResponse(), metadata
