...
class _BaseDatastoreAdminRestTransport(DatastoreAdminTransport):
    ...
    class _BaseExportEntities:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseDatastoreAdminRestTransport._BaseExportEntities._get_unset_required_fields(query_params))
    ...
    class _BaseImportEntities:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseDatastoreAdminRestTransport._BaseImportEntities._get_unset_required_fields(query_params))
