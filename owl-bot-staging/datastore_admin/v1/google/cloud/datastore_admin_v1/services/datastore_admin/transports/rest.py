...
class DatastoreAdminRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_index(self, request: datastore_admin.CreateIndexRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore_admin.CreateIndexRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_delete_index(self, request: datastore_admin.DeleteIndexRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore_admin.DeleteIndexRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_export_entities(self, request: datastore_admin.ExportEntitiesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore_admin.ExportEntitiesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_export_entities_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_entities
    ...
    def pre_get_index(self, request: datastore_admin.GetIndexRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore_admin.GetIndexRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_import_entities(self, request: datastore_admin.ImportEntitiesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore_admin.ImportEntitiesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_import_entities_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for import_entities
    ...
    def pre_list_indexes(self, request: datastore_admin.ListIndexesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore_admin.ListIndexesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_indexes_with_metadata(self, response: datastore_admin.ListIndexesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[datastore_admin.ListIndexesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_indexes
...
class DatastoreAdminRestTransport(_BaseDatastoreAdminRestTransport):
    ...
    class _CreateIndex(_BaseDatastoreAdminRestTransport._BaseCreateIndex, DatastoreAdminRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreAdminRestTransport._BaseCreateIndex._get_http_options()

            request, metadata = self._interceptor.pre_create_index(request, metadata)
            transcoded_request = _BaseDatastoreAdminRestTransport._BaseCreateIndex._get_transcoded_request(http_options, request)

            body = _BaseDatastoreAdminRestTransport._BaseCreateIndex._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDatastoreAdminRestTransport._BaseCreateIndex._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreAdminRestTransport._CreateIndex._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteIndex(_BaseDatastoreAdminRestTransport._BaseDeleteIndex, DatastoreAdminRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreAdminRestTransport._BaseDeleteIndex._get_http_options()

            request, metadata = self._interceptor.pre_delete_index(request, metadata)
            transcoded_request = _BaseDatastoreAdminRestTransport._BaseDeleteIndex._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDatastoreAdminRestTransport._BaseDeleteIndex._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreAdminRestTransport._DeleteIndex._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ExportEntities(_BaseDatastoreAdminRestTransport._BaseExportEntities, DatastoreAdminRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreAdminRestTransport._BaseExportEntities._get_http_options()

            request, metadata = self._interceptor.pre_export_entities(request, metadata)
            transcoded_request = _BaseDatastoreAdminRestTransport._BaseExportEntities._get_transcoded_request(http_options, request)

            body = _BaseDatastoreAdminRestTransport._BaseExportEntities._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDatastoreAdminRestTransport._BaseExportEntities._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreAdminRestTransport._ExportEntities._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_export_entities_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _GetIndex(_BaseDatastoreAdminRestTransport._BaseGetIndex, DatastoreAdminRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreAdminRestTransport._BaseGetIndex._get_http_options()

            request, metadata = self._interceptor.pre_get_index(request, metadata)
            transcoded_request = _BaseDatastoreAdminRestTransport._BaseGetIndex._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDatastoreAdminRestTransport._BaseGetIndex._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreAdminRestTransport._GetIndex._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ImportEntities(_BaseDatastoreAdminRestTransport._BaseImportEntities, DatastoreAdminRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreAdminRestTransport._BaseImportEntities._get_http_options()

            request, metadata = self._interceptor.pre_import_entities(request, metadata)
            transcoded_request = _BaseDatastoreAdminRestTransport._BaseImportEntities._get_transcoded_request(http_options, request)

            body = _BaseDatastoreAdminRestTransport._BaseImportEntities._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseDatastoreAdminRestTransport._BaseImportEntities._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreAdminRestTransport._ImportEntities._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_import_entities_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _ListIndexes(_BaseDatastoreAdminRestTransport._BaseListIndexes, DatastoreAdminRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreAdminRestTransport._BaseListIndexes._get_http_options()

            request, metadata = self._interceptor.pre_list_indexes(request, metadata)
            transcoded_request = _BaseDatastoreAdminRestTransport._BaseListIndexes._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDatastoreAdminRestTransport._BaseListIndexes._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreAdminRestTransport._ListIndexes._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = datastore_admin.ListIndexesResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _CancelOperation(_BaseDatastoreAdminRestTransport._BaseCancelOperation, DatastoreAdminRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseDatastoreAdminRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDatastoreAdminRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreAdminRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseDatastoreAdminRestTransport._BaseDeleteOperation, DatastoreAdminRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseDatastoreAdminRestTransport._BaseDeleteOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDatastoreAdminRestTransport._BaseDeleteOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreAdminRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseDatastoreAdminRestTransport._BaseGetOperation, DatastoreAdminRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreAdminRestTransport._BaseGetOperation._get_http_options()

            request, metadata = self._interceptor.pre_get_operation(request, metadata)
            transcoded_request = _BaseDatastoreAdminRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDatastoreAdminRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreAdminRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseDatastoreAdminRestTransport._BaseListOperations, DatastoreAdminRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseDatastoreAdminRestTransport._BaseListOperations._get_http_options()

            request, metadata = self._interceptor.pre_list_operations(request, metadata)
            transcoded_request = _BaseDatastoreAdminRestTransport._BaseListOperations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseDatastoreAdminRestTransport._BaseListOperations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = DatastoreAdminRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
